...
- All release builds are now CGO-free and the cross-toolchain install step is gone; gt does not need the ICU cgo path, and Linux CI cannot cross-compile it for arm64 or darwin anyway.
